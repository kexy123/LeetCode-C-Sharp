...
{
    /// <summary>
    /// Finds the median of two sorted arrays, <paramref name="nums1"/> and <paramref name="nums2"/>,
    /// as if they were merged and sorted.
    /// </summary>
    ...
    public double FindMedianSortedArrays(int[] nums1, int[] nums2)
    {
        ...
        // These are nested if-statements, but this is for simplification.
        int i1 = 0, i2 = 0;
        ...
        // Solve for the median case where there are an even number of elements in the merged array.
        // The even-check bitwise formula gets inlined during compilation: (size & 1) == 0.
