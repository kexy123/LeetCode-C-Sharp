...
public partial class Solution
{
    ...
    /// is height-balanced, where the depth of the subtrees
    /// in every <see cref="TreeNode"/> differ by at most
    /// one.
    /// </summary>
    /// <param name="root">The starting <see cref="TreeNode"/>.</param>
    /// <returns><see langword="true"/> if the binary <see cref="TreeNode"/> is height-balanced; otherwise <see langword="false"/>.</returns>
    public bool IsBalanced(TreeNode? root)
    {
        ...
        static int CheckAndGetDepth(TreeNode? node, int depth)
        {
            ...
            {
                // The binary TreeNode is invalid; return -1.
                return -1;
            }
