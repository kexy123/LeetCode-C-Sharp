...
{
    /// <summary>
    /// Increments 1 to the given <paramref name="digits"/> <see langword="int"/> array.
    /// </summary>
    /// <param name="digits">The <see langword="int"/> digits to affect.</param>
    /// <returns>The new incremented value.</returns>
    public int[] PlusOne(int[] digits)
    {
        // Move to the least-significant digit that isn't a 9, while setting all the 9's after it to 0.
        // 9 + 1 = 10, which overflows to the next digit.
