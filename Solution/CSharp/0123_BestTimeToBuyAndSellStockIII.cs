...
//      Memory:     62.38 MB
//
// Unfortunately had to look up a solution as grasping the problem was difficult for me.
...
public partial class Solution
{
    ...
    /// <paramref name="prices"/> <see langword="int"/> array at most twice, however only being able to
    /// hold one stock at a time.
    /// </summary>
    ...
    public int MaxProfit(int[] prices)
    {
        ...
        foreach (int price in prices)
        {
            ...
            // Find the biggest element to the right of where maxBuy0 was such that it can find the
            // biggest profit for the first sell transaction.
        ...
        // If no possible profit can be made, simply return 0.
