...
{
    /// <summary>
    /// Multiples two strings <paramref name="num1"/> and <paramref name="num2"/> together, given that
    /// they are positive whole numbers.
    /// </summary>
    /// <param name="num1">The first number.</param>
    /// <param name="num2">The second number.</param>
    /// <returns>The multiplicative result as a <see langword="string"/>.</returns>
    public string Multiply(string num1, string num2)
    {
        ...
        // The maximum length of a string that is the product of two other strings is the sum of the
        // digits plus 1.
        ...
        foreach (char digit2 in num2.Reverse())
        {
            ...
            if (digit == 0)
            {
                // Multiplicative identity; it would be unnecessary to add zeroes repetitively.
                continue;
            }
            ...
            {
                // The multiplication of two digits added with a carry that is less than 10 will always
                // be at most 2 digits long.
        ...
        // Adds a digit at a given index and applies carry-on addition operations to the digits
        // behind it.
