...
{
    /// <summary>
    /// Merges <paramref name="nums2"/> into <paramref name="nums1"/> retaining ascending sorting order
    /// given that <paramref name="nums1"/> has enough space for the elements
    /// in <paramref name="nums2"/>.
    /// </summary>
    ...
    public void Merge(int[] nums1, int m, int[] nums2, int n)
    {
        ...
        {
            // Check if nums2Right is still in bounds and nums1Right is out of bounds or the element at
            // nums1[nums1Right] is less than nums2[nums2Right].
