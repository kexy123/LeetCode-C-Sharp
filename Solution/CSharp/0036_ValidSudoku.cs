...
public partial class Solution
{
    ...
    /// cells are marked with full stops ('.').
    /// </summary>
    /// <param name="board">The 9x9 <see cref="char"/> matrix to inspect.</param>
    ...
    public bool IsValidSudoku(char[][] board)
    {
        ...
        {
            // .NET 10.0 CoreCLR does not transform
            // x / 3 * 3 -> x during compilation.
