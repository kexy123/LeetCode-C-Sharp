...
{
    /// <summary>
    /// Checks if <paramref name="p"/> and <paramref name="q"/> have the same <see cref="TreeNode"/>
    ...
    {
        // Null checks; check if both parameters are null. If they are, they are the same tree.
        if (p is null)
        {
            return q is null;
        }
        ...
        // Check if both the left and right trees are the same.
