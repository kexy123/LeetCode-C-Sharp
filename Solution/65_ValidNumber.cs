...
public partial class Solution
{
    ...
    /// a <c>E</c>. Both integers and decimals
    /// can have a leading plus or minus sign.
    /// Integers contain only digits, while
    /// decimals can either be (1) Digits
    /// followed by a decimal point, (2) Digits
    /// followed by a decimal point followed by
    /// more digits, or (3) A decimal point
    /// followed by digits.
    /// </summary>
